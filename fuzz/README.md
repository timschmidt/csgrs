...
transforms, region-to-solid grammar, Hypermesh/Hypercurve handoffs, and
...
- grammar and topology: `fuzz_mesh_bytecode`,
  `fuzz_curve_polygon_triangulate`, `fuzz_mesh_boolean_pair`,
...
- construction: `fuzz_mesh_primitive_catalog`,
  `fuzz_curve_shape_catalog`, `fuzz_mesh_polyhedron_constructor`,
  `fuzz_curve_extrude_revolve_sweep`; these targets reject exact duplicate or
  degenerate triangles and require closed geometric manifolds from every
  non-empty solid constructor;
- Hyper handoffs and implicit geometry: `fuzz_mesh_hypermesh_adapter`,
  `fuzz_sdf_tpms`, `fuzz_metaballs_boundary`;
- modeling support: `fuzz_transform_matrix`, `fuzz_part_blueprint`.
